...
- [Workflow](#workflow)
  ...
  - [8. Cosmetic Coherence](#8-cosmetic-coherence)
...
# Rules
## Git Safety
- Never add claude as co-author in commit message. Also don't mention Generated by claude.
...
- Plans and Specs to be written in org format only unless specified otherwise
...
## 8. Cosmetic Coherence
- Stick to the formatting rules of the project, either use the autoformatter if present OR run the format compliance tools.
- Do so wherever possible only for the region of code introduced in the session.
- If required make separate commits for formatting.
